...
$headerData = [
    "logo" => "https://loghi-famosi.com/wp-content/uploads/2020/09/Google-Logo-650x366.png",
    "pageName" => "privacy e termini",
    "userAvatar" => "https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/User-avatar.svg/1024px-User-avatar.svg.png",
    "navbar" => [
        ["text" => "introduzione", "href" => "#",],
        ["text" => "norme sulla privacy", "href" => "#",],
        ["text" => "termini di servizio", "href" => "#",],
        ["text" => "tecnologie", "href" => "#",],
        ["text" => "domande frequenti", "href" => "#",],
    ]
];
...
$data = [
    [
        "title" => [
            "text" => "Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?",
            "tag" => "h2",
        ],
        "paragraphList" => [
            [
    ...
    [
        "title" => [
            "text" => "Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?",
            "tag" => "h2",
        ],
        "paragraphList" => [
            [
            ...
            [
                "text" => "Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel  <a href='#'>Centro Google per la sicurezza online.</a>",
                "tag" => "p",
            ],
            [
                "text" => " <a href='#'>Scopri</a> quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.",
                "tag" => "p",
            ],
        ]
    ],
    [
        "title" => [
            "text" => "Perché il mio account è associato a un paese?",
            "tag" => "h2",
        ],
        "paragraphList" => [
            [
            ...
            [
                "text" => "<li>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:<ol><li>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li><li>Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li></ol></li><li>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</li>",
                "tag" => "ol",
            ],
            [
    ...
    [
        "title" => [
            "text" => "Stabilire il paese associato al tuo account",
            "tag" => "h3",
        ],
        "paragraphList" => [
            [
    ...
    [
        "title" => [
            "text" => "Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?",
            "tag" => "h2",
        ],
        "paragraphList" => [
            [
    ...
    [
        "title" => [
            "text" => "Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?",
            "tag" => "h2",
        ],
        "paragraphList" => [
            [
...
<body>
    <header class="custom-header">
        <div class="header-first-row d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center">
                <img class="logo-img" src="<?php echo $headerData["logo"] ?>" alt="logo">
                <span class="page-name px-1"><?php echo $headerData["pageName"] ?></span>
            </div>
            <div class="d-flex align-items-center gap-3">
                <div class="circular-container">
                    <i class="custom-icon fas fa-th"></i>
                </div>
                <div class="circular-container">
        ...
        <nav class="custom-navbar">
            <ul class="navbar-list">
                <?php
                foreach ($headerData["navbar"] as $navObject) {
                ?>
                    <li> <a class="<?php echo $navObject["text"] == "domande frequenti" ? 'active' : '' ?>" href="<?php echo $navObject["href"] ?>"><?php echo $navObject["text"] ?></a> </li>
                <?php
                }
                ?>
            </ul>
    ...
    <main>
        <div class="container py-5">
            ...
            foreach ($data as $section) {
                ...
                $sectionTag = $section["title"]["tag"];
                echo "<section>";
                echo "<$sectionTag>$sectionTitle</$sectionTag>";
                foreach ($section["paragraphList"] as $singleParagraph) {
                    $singleParagraphText = $singleParagraph["text"];
                    $singleParagraphTag = $singleParagraph["tag"];
                    echo "<$singleParagraphTag>$singleParagraphText</$singleParagraphTag>";
                }
                echo "</section>";
            }
            ?>
